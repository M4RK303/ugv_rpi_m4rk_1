...
cron_job1="@reboot XDG_RUNTIME_DIR=/run/user/$(id -u) ~/ugv_rpi_m4rk_1/ugv-env/bin/python ~/ugv_rpi_m4rk_1/app.py >> ~/ugv.log 2>&1"

# Define the second cron job for starting Jupyter
cron_job2="@reboot /bin/bash ~/ugv_rpi_m4rk_1/start_jupyter.sh >> ~/jupyter_log.log 2>&1"
